...
export class UserController {
  ...
  @ApiOperation({
    ...
    description: 'Returns all users together with their profile relation for administrative management.',
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({
    ...
    description: 'Returns one user together with related profile, payment, and verification data.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Deletes a user account. Related data is handled according to the configured database cascade rules.',
  })
  @ApiUuidParam('id', 'The user UUID')
  @ApiResponse({
    status: 204,
  ...
  @ApiOperation({
    ...
    description: 'Assigns a mentor to the specified user profile by mentor UUID.',
  })
  @ApiUuidParam('id', 'The user UUID')
  @ApiBody({ type: UpdateUserMentorDto })
  @ApiResponse({ status: 200, description: 'Mentor successfully assigned' })
  @ApiResponse({ status: 400, description: 'Bad Request - invalid mentor assignment payload' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admins only' })
  ...
  @ApiOperation({
    ...
    description: 'Activates or deactivates a user account. Deactivated users can still log in, but their content view is frozen from the deactivation time.',
  })
  @ApiUuidParam('id', 'The user UUID')
  @ApiResponse({ 
    status: 200, 
